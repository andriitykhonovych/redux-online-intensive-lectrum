...
import { showNextPhoto, showSelectedPhoto, showPreviousPhoto } from "../../bus/gallery/action";
...
export default class Gallery extends Component {
    ...
    render () {
        ...
        const buttonActiveStyle1 = classNames({ [Styles.buttonActive]: selectedPhotoIndex === 0 });
        const buttonActiveStyle2 = classNames({ [Styles.buttonActive]: selectedPhotoIndex === 1 });
        const buttonActiveStyle3 = classNames({ [Styles.buttonActive]: selectedPhotoIndex === 2 });
        const buttonActiveStyle4 = classNames({ [Styles.buttonActive]: selectedPhotoIndex === 3 });
